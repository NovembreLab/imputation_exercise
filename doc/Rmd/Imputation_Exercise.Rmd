...
specified in the files starting with *"example.chr.1kg"*. **Save the following
command into a new file named "execute_impute.sh"**:
...
both PLINK, GTOOL, IMPUTE2, and BASH commands to work through this scenario, in

...
*Problem 6* According to this analysis, what is the most highly associated SNP?
...
*Problem 7* Export the *gwas_array.assoc* file and produce a Manhattan plot in RStudio. Make sure to use the appropriate
...
*Problem 10* Run a basic association on the *real_small_imputed* files (using the steps from 2.1.2). Save the output to *results/gwas_imputed.assoc*.

*Problem 11* Use your BASH knowledge to find the most highly associated SNP in
the *"gwas_imputed.assoc"* file. What SNP is it? What is the non-adjusted p-value?

### *2.5: Manhattan Plot of Imputed GWAS*

Lastly, we will visualize the results of our GWAS with imputed SNPs by exporting
our *"gwas_imputed.assoc"* file to our computer and plot it using RStudio.

*Problem 12* Similar to Problem 11, produce a Manhattan plot for the *results/gwas_imputed.assoc* in
